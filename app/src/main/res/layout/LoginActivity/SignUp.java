...
public class SignUp extends AppCompatActivity {
    ...
    private com.nineinfosys.android.incometax.LoginActivity.User user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignUp_User.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(password.length()<=5){
                    Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.SignUp.this, "Password Should Contain Minimum 6 Characters", Toast.LENGTH_SHORT).show();
                    password.setText("");
                }

                if(!email.getText().toString().trim().matches(emailpattern)){
                    Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.SignUp.this, "Enter Valid Email id?", Toast.LENGTH_SHORT).show();
                    email.setText("");
                }
        ...
        UserLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(com.nineinfosys.android.incometax.LoginActivity.SignUp.this, com.nineinfosys.android.incometax.LoginActivity.Login.class));
            }
        });
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.SignUp.this, "Already Registered!", Toast.LENGTH_SHORT).show();
                        } else {
       ...
       // Toast.makeText(SignUp.this, "Verification email sent to " + user.getEmail(), Toast.LENGTH_SHORT).show();
        ...
        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.SignUp.this,
