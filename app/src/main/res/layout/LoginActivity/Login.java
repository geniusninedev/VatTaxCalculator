...
public class Login extends AppCompatActivity {
    ...
    public com.nineinfosys.android.incometax.LoginActivity.User user;
               ...
               FirebaseUser mUser = firebaseAuth.getCurrentUser();
                ...
                if (mUser != null) {
                    if (mUser.isEmailVerified()) {
                        Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "You are in =)", Toast.LENGTH_LONG).show();
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(getApplicationContext())
                .enableAutoManage(this, new GoogleApiClient.OnConnectionFailedListener() {
                    ...
                    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
                        ...
                        Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "You got an error", Toast.LENGTH_SHORT).show();
                    }
                })
                        ...
                        new GraphRequest.GraphJSONObjectCallback() {
                            ...
                            public void onCompleted(
                                ...
                                try {
                                    ...
                                    user = new com.nineinfosys.android.incometax.LoginActivity.User();
                                ...
                                Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Welcome " + user.getName(), Toast.LENGTH_LONG).show();
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            if (password != user.getPassword() || email != user.getEmail()) {
                                Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Incorrect Email or Password? If Not Registered? Register First!", Toast.LENGTH_SHORT).show();
                            }
                            ...
                            if (mUser.isEmailVerified()) {
                              ...
                              //  mUser.sendEmailVerification();
                                Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this,"Verify your email first...",Toast.LENGTH_LONG).show();
                            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Authentication failed.",Toast.LENGTH_SHORT).show();
                            signOut();
                        }else{
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Log.w(TAG, "signInWithCredential", task.getException());
                            Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Authentication failed.",
                ...
                mAuth.sendPasswordResetEmail(emailid)
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                ...
                                if (task.isSuccessful()) {
                                    Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Password Resetting Link Sent To Email Id ", Toast.LENGTH_SHORT).show();
                                } else {
                                    Log.e(TAG, "sendEmailVerification", task.getException());
                                    Toast.makeText(com.nineinfosys.android.incometax.LoginActivity.Login.this, "Enter Registered Email Id.", Toast.LENGTH_SHORT).show();
                                }
